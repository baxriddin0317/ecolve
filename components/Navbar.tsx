    ...
    <header className={cn("fixed inset-x-0 z-50 transition-all duration-300 ease-linear", className ,`${fixed ? 'top-0' : 'top-8'}`)}>
      ...
      <div className="max-w-8xl px-4 mx-auto flex items-center justify-between gap-20 ">
        <div className="w-full flex-1 flex items-center gap-6">
          ...
          <div className={`w-full flex-1 relative flex items-center gap-4 ${fixed ? '' : 'bg-white/10'} px-8 rounded-full transition-all duration-300 ease-linear`}>
            ...
            <button className="w-40 h-10 rounded-xl bg-white text-black border border-black font-bold ml-auto">
              Get Started
            </button>
          </div>
        </div>
